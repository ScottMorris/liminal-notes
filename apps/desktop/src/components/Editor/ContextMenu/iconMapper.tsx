...
const PastePlainIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path>
    <rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect>
    <text x="12" y="17.5" fontSize="10" textAnchor="middle" fill="currentColor" fontWeight="bold">T</text>
  </svg>
);
...
export function getIconByName(name?: string): React.ReactNode {
  ...
  switch (name) {
    ...
    // Window Controls
    case 'WindowRestoreIcon': return <WindowRestoreIcon size={16} />;
    case 'WindowMaximizeIcon': return <WindowMaximizeIcon size={16} />;
    case 'WindowMinimizeIcon': return <WindowMinimizeIcon size={16} />;
